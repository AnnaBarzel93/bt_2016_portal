...
\newcommand{\dcauthorpre}{Frau} %ggf Titel
\newcommand{\dcauthorsurname}{Barzel} 
\newcommand{\dcauthorname}{Anna} 
\newcommand{\dcauthoradd}{26.08.1993} %geboren am 
\newcommand{\dcauthorno}{5684} %Matrikelnummer

%-Titel und Untertitel / Title and subtitle-----------------------

\newcommand{\dctitle}{Einführung eines Kundenportals inklusive Aufbau einer konzernweiten Integrationsplattform} 
...
\newcommand{\dcapprovala}{Dr. Johannes Sauer} 
\newcommand{\dcapprovalb}{Dr.-Ing. Jan Himmelspach} 
\newcommand{\dcapprovalc}{} 

%-Eingabe der Betreuernamen / Name of the advisors ---------------

\newcommand{\dcada}{Marcus Daul}
